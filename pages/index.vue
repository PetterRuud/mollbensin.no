          ...
          <div class="box">
            <div class="box-inner">
              <div class="box-content">
                ...
                <p>
                  Salg og service av gressklippere, snøfresere, motorsager og
                  andre skog- og hageprodukter.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="box-inner">
              <div class="box-content">
                ...
                <p>
                  ...
                  <a href="/kontakt/" title="Avvikende åpningstider"
                    >Klikk for avvik</a
                  >
                </p>
              </div>
            ...
            <div class="box-inner">
              <div class="box-content">
                ...
                <a href="https://www.finn.no/butikk/mollb.html">
                  <h2>Besøk vår butikkside på Finn.no for priser og tilbud.</h2>
                </a>
              </div>
            </div>
          </div>
...
.index {
  // background-image: url('~static/H350-0271.jpg');
