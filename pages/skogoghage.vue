<template>
  <div class="container gutter">
    ...
    <h2>Robotklippere</h2>
    <p>
      Med en robotgressklipper kan du få en frodig, grønn plen uten å måtte
      bruke tid på gressklipping. Dette er batteridrevne gressklippere som slår
      gresset på egenhånd. Vi leverer robotklippere fra Husqvarna og Honda.
    </p>

    <h2>Gressklippere</h2>
    <p>
      En gressklipper er ikke bare en gressklipper. Vi har et stort utvalg
      klippere med funksjonalitet som trinnløs fremdrift, bioklipp, knivstopp og
      elektrisk start, for å nevne noe. Kom innom en tur, så hjelper vi deg å
      finne en modell som passer dine behov. Vi har klippere fra Honda, Jonsered
      og Klippo.
    </p>

    <h2>Motorsager</h2>
    <p>
      Våre sager har den mest avanserte motorsagteknologien, uten at det går på
